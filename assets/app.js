...
$(document).ready(function () {
    $("#filter").change(function () {
        ...
        // faire une requete asycrhome
        // soit ajax
        // soit l'api fetch
        // api fetch= attends un url , ici /filter
        // un protocole http ( post ou get )
        ...
        async function fetchData(filter) {
            try {
                ...
                const response = await fetch(url, {
                    ...
                    // signature de la méthode, quel type de contenu j'attends : ici json
                    headers: {
        ...
        // comment récuperer la valeur de mon filtre qui a changé
        fetchData(filter);
